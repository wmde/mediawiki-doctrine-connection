...
cp -r $originalDirectory doctrine-connection

cd doctrine-connection
composer install

cd ../../..

echo 'include_once( __DIR__ . "/vendor/mediawiki/doctrine-connection/vendor/autoload.php" );' >> LocalSettings.php
